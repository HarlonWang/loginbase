...
export async function initDb() {
  const schema = `
    ...
    CREATE TABLE IF NOT EXISTS auth_events (id INTEGER PRIMARY KEY AUTOINCREMENT, at INTEGER NOT NULL, event TEXT NOT NULL, outcome TEXT, provider TEXT, user_id TEXT, flow_id TEXT, is_new_user INTEGER, country TEXT, asn INTEGER, colo TEXT, timezone TEXT, city TEXT, region TEXT, source TEXT NOT NULL DEFAULT 'server', meta TEXT);
  `;
